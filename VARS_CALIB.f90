...
!---------------------------------------------------------------------------------
    ...
    REAL,ALLOCATABLE:: DSUP_SC(:,:,:)  !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: Q_SC(:,:)       !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: VOLTREC2_SC(:,:)!Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: VFL2_SC(:,:)    !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: SfTRECx_SC(:,:) !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: HmJx_SC(:,:)    !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: HFLSD_SC(:,:)   !Hugo Fagundes 03/10/2019
    REAL,ALLOCATABLE:: TKS_SC(:)
