...
!---------------------------------------------------------------------------------
	...
	INTEGER,PARAMETER:: NMAXHID=800 !Maximum number of points taht one wants hydrographs output to be saved
...
!	!Calibration
	INTEGER ICALIB
	REAL,ALLOCATABLE:: R2(:),ERRV(:),R2L(:),CORRELAC(:) !coef. nash, error in volumes, coef nash logarithms, r correlation coef.
	...
	REAL,ALLOCATABLE:: Qmini(:,:) !LBF 11/2018 MGB_SEDIN
